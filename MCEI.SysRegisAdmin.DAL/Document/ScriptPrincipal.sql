...
CREATE TABLE [Servers](
	Id INT NOT NULL PRIMARY KEY IDENTITY (1,1),
	IdMembershipp INT NOT NULL FOREIGN KEY REFERENCES Memberships(Id),
	IdPrivilege INT NOT NULL FOREIGN KEY REFERENCES Privileges(Id),
	[Status] TINYINT NOT NULL,
	DateCreated DATETIME NOT NULL,
    DateModification DATETIME NOT NULL,
);
GO
CREATE TABLE HistoryServers(
	Id INT NOT NULL PRIMARY KEY IDENTITY (1,1),
	IdMembershipp INT NOT NULL FOREIGN KEY REFERENCES Memberships(Id),
	IdPrivilege INT NOT NULL FOREIGN KEY REFERENCES Privileges(Id),
	[Status] TINYINT NOT NULL,
